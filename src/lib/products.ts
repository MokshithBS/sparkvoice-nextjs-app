export interface Product {
  ...
  export const products: Product[] = [
    ...
    { id: 40, name: 'Amul Cheese Slices', price: 120, quantity: '200 g', image: 'https://storage.googleapis.com/aip-dev-images-public/product-cheese.png', category: 'Dairy, Bread & Eggs', hint: 'cheese slices' },
    ...
    { id: 23, name: 'Royal Gala Apples', price: 180, quantity: '1 kg', image: 'https://storage.googleapis.com/aip-dev-images-public/product-apples.png', category: 'Vegetables & Fruits', hint: 'apples' },
    ...
    { id: 12, name: 'Lays Potato Chips', price: 20, quantity: 'Classic Salted', image: 'https://storage.googleapis.com/aip-dev-images-public/snacks.png', category: 'Snacks & Beverages', hint: 'potato chips' },
    ...
    { id: 39, name: 'Bru Instant Coffee', price: 250, quantity: '100 g', image: 'https://storage.googleapis.com/aip-dev-images-public/product-bru-coffee.png', category: 'Snacks & Beverages', hint: 'coffee jar' },

    // Instant & Frozen Food
    { id: 9, name: 'Maggi 2-Min Noodles', price: 14, quantity: '1 pack', image: 'https://storage.googleapis.com/aip-dev-images-public/product-maggi.png', category: 'Instant & Frozen Food', hint: 'instant noodles' },
    ...
    { id: 51, name: 'Colin Glass Cleaner', price: 90, quantity: '500 ml', image: 'https://storage.googleapis.com/aip-dev-images-public/product-colin.png', category: 'Cleaning Essentials', hint: 'spray bottle' },
    ...
    { id: 49, name: 'Dettol Handwash', price: 99, quantity: '200 ml', image: 'https://storage.googleapis.com/aip-dev-images-public/product-handwash.png', category: 'Personal Care', hint: 'hand soap' },

    // Baby Care
    { id: 55, name: 'Pampers Diapers', price: 500, quantity: 'M size 50 pack', image: 'https://storage.googleapis.com/aip-dev-images-public/product-diapers.png', category: 'Baby Care', hint: 'diapers pack' },
