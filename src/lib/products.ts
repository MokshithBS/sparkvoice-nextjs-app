...
export interface Product {
  ...
  export const products: Product[] = [
    ...
    // Vegetables & Fruits
    { id: 7, name: 'Fresh Onions (1 kg)', price: 40, quantity: '1 kg', image: 'https://via.placeholder.com/400x300/8B4513/FFFFFF?text=Fresh+Onions', category: 'Vegetables & Fruits', hint: 'onions', isVeg: true, packaging: 'Net Bag' },
    { id: 8, name: 'Fresh Tomatoes (1 kg)', price: 30, quantity: '1 kg', image: 'https://via.placeholder.com/400x300/FF6347/FFFFFF?text=Fresh+Tomatoes', category: 'Vegetables & Fruits', hint: 'tomatoes', isVeg: true, packaging: 'Loose' },
    { id: 22, name: 'Fresh Potatoes (1 kg)', price: 35, quantity: '1 kg', image: 'https://via.placeholder.com/400x300/D2691E/FFFFFF?text=Fresh+Potatoes', category: 'Vegetables & Fruits', hint: 'potatoes', isVeg: true, packaging: 'Net Bag' },
    { id: 23, name: 'Royal Gala Apples (1 kg)', price: 180, salePrice: 149, quantity: '1 kg', image: 'https://via.placeholder.com/400x300/DC143C/FFFFFF?text=Royal+Gala+Apples', category: 'Vegetables & Fruits', hint: 'apples', isVeg: true, packaging: 'Loose' },
    { id: 24, name: 'Robusta Bananas (1 dozen)', price: 50, quantity: '1 dozen', image: 'https://via.placeholder.com/400x300/FFD700/000000?text=Robusta+Bananas', category: 'Vegetables & Fruits', hint: 'bananas bunch', isVeg: true, packaging: 'Loose' },
    { id: 44, name: 'Fresh Coriander (1 bunch)', price: 10, quantity: '1 bunch', image: 'https://via.placeholder.com/400x300/228B22/FFFFFF?text=Fresh+Coriander', category: 'Vegetables & Fruits', hint: 'coriander leaves', isVeg: true, packaging: 'Loose' },
    { id: 45, name: 'Fresh Ginger (100 g)', price: 20, quantity: '100 g', image: 'https://via.placeholder.com/400x300/F4A460/FFFFFF?text=Fresh+Ginger', category: 'Vegetables & Fruits', hint: 'ginger root', isVeg: true, packaging: 'Loose' },
    { id: 46, name: 'Fresh Garlic (100 g)', price: 25, quantity: '100 g', image: 'https://via.placeholder.com/400x300/F5F5DC/000000?text=Fresh+Garlic', category: 'Vegetables & Fruits', hint: 'garlic bulb', isVeg: true, packaging: 'Loose' },
    { id: 67, name: 'Fresh Cabbage (1 pc)', price: 30, quantity: '1 pc', image: 'https://via.placeholder.com/400x300/9ACD32/FFFFFF?text=Fresh+Cabbage', category: 'Vegetables & Fruits', hint: 'cabbage head', isVeg: true, packaging: 'Loose' },
    { id: 68, name: 'Fresh Cauliflower (1 pc)', price: 40, quantity: '1 pc', image: 'https://via.placeholder.com/400x300/F5F5F5/000000?text=Fresh+Cauliflower', category: 'Vegetables & Fruits', hint: 'cauliflower head', isVeg: true, packaging: 'Loose' },
