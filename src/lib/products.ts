...
export interface Product {
  ...
  export const products: Product[] = [
    ...
    { id: 108, name: 'Paper Boat Aamras (200 ml)', price: 30, quantity: '200 ml', image: 'https://storage.googleapis.com/aip-dev-images-public/product-paper-boat.png', category: 'Snacks & Beverages', hint: 'juice pack', isVeg: true },
    ...
    { id: 37, name: "Haldiram's Aloo Bhujia (200 g)", price: 50, salePrice: 40, quantity: '200 g', image: 'https://storage.googleapis.com/aip-dev-images-public/product-bhujia.png', category: 'Snacks & Beverages', hint: 'indian snacks', isVeg: true },
