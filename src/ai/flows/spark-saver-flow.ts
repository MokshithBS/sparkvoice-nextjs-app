...
4.  **Format Output**: For each selected item, determine the quantity to add to the cart.
    - The 'product' and 'englishProduct' fields MUST be the exact product name from the available products list.
    - The 'quantity' field MUST be the quantity to add to the cart, as a string (e.g., "1", "2").
