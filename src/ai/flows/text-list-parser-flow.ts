...
4.  **Quantity Calculation**: This is the most critical step. Calculate how many units of the matched store product are needed to fulfill the user's request.
    -   Example 1: If the user types "15kg Rice" and the available product is a "5 kg" pack, you must calculate that the user needs **3** units. The 'quantity' field should be "3".
