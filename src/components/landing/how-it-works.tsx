...
import { Camera, FileText, MicVocal } from "lucide-react"
...
const steps = [
  ...
  },
  {
    ...
    title: "3. Text or Paste It",
    description: "Send a list via WhatsApp, copy it from your notes, or type it in. SparkVoice intelligently parses it.",
